...
const Chat = () => {
    ...
    const [messages, setMessages] = useState([
        { role: 'bot', content: "Welcome, explorer. I am your AI guide to Ethiopia. Ask me anything about our history, sites, or culture." }
    ]);
                ...
                <div style={styles.main}>
                    <div style={styles.header}>
                        <div style={styles.botInfo}>
                            ...
                            <div>
                                <h2 style={styles.botName}>AITopia Messenger</h2>
                    ...
                    <div style={styles.messagesContainer} ref={scrollRef}>
                        ...
                        {loading && (
                            <div style={styles.loadingWrapper}>
                                ...
                                <span style={{ fontSize: '0.85rem', color: 'var(--color-text-light)' }}>Consulting ancient scrolls...</span>
                            </div>
                        )}
                    </div>
                    ...
                    <form onSubmit={handleSend} style={styles.inputArea}>
                        <input
                            ...
                            placeholder="Ask about the Blue Nile, Lalibela, or the Axum Stele..."
                            style={styles.input}
                        />
